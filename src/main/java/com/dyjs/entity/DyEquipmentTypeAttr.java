...
public class DyEquipmentTypeAttr {
    private String id;
	...
	private DyEquipmentAttrConfig equipmentAttrConfig;
	...
	public DyEquipmentAttrConfig getEquipmentAttrConfig() {
		return equipmentAttrConfig;
	}

	public void setEquipmentAttrConfig(DyEquipmentAttrConfig equipmentAttrConfig) {
		this.equipmentAttrConfig = equipmentAttrConfig;
	}
}